...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var activityArray = [{ id: 1, avatar: "http://placehold.it/80x80&text=[img]", user: "Bob Bob", description: "Now, look here, my good man. Where'd you get the coconuts? No, no, no! Yes, yes. A bit. But she's got a wart." }, { id: 2, avatar: "http://placehold.it/80x80&text=[img]", user: "Jim Jim", description: "Found them? In Mercia?! The coconut's tropical! Well, she turned me into a newt. And the hat. She's a witch!" }, { id: 3, avatar: "http://placehold.it/80x80&text=[img]", user: "Jill Jill", description: "A newt? Why do you think that she is a witch? What a strange person. You don't vote for kings. Did you dress her up like this? Well, I didn't vote for you. What do you mean? No, no, no! Yes, yes. A bit. But she's got a wart. Bring her forward! No, no, no! Yes, yes. A bit. But she's got a wart." }, { id: 4, avatar: "http://placehold.it/80x80&text=[img]", user: "Ted Ted", description: "Well, Mercia's a temperate zone! You don't frighten us, English pig-dogs! Go and boil your bottoms, sons of a silly person! I blow my nose at you, so-called Ah-thoor Keeng, you and all your silly English K-n-n-n-n-n-n-n-niggits! You don't vote for kings. Ah, now we see the violence inherent in the system! She looks like one." }];
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "a",
	        { href: "#" },
	        React.createElement("img", { className: "img-round", src: "http://placehold.it/300x300&text=[img]" })
	      ),
	      React.createElement(
	        "h5",
	        null,
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "p",
	        null,
	        React.createElement("img", { src: "http://placehold.it/300x440&text=[ad]" })
	      ),
	      React.createElement(
	        "p",
	        null,
